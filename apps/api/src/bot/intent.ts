...
const buyKeywords = [
  'llevo', 'lo llevo', 'comprar', 'compro', 'quiero comprar', 'lo compro',
  'reservo', 'reserva', 'seño', 'seña', 'me lo guardas', 'me lo guardás',
  'lo quiero', 'donde pago', 'cómo pago', 'como pago', 'pagarte', 'pagar',
  'pasame cbu', 'pasame el alias', 'transferencia', 'retiro', 'cuando puedo pasar'
];
